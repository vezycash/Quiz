const quiz = [
  ...
  {
    title: "The earth has three layers of varying temperatures called:",
    choices: [
      "crust, mantle, and core",
      "mantle, crust and ozone",
      "ozone, core, and mantle",
      "ozone, crust, and core",
    ],
    answer: "crust, mantle, and core",
  },
  {
    title: "The function of leafs in plant:",
    choices: [
      "photosynthesis",
      "absorbtion of water",
      "production of chloropyll",
      "plant respiration",
    ],
    answer: "photosynthesis",
  },
  {
    title: "What is the largest known animal?",
    choices: ["Blue whale", "Kimono dragon", "Elephant", "killer shark"],
    answer: "Blue whale",
  },
  {
    title: "A blue whale is a?",
    choices: ["mammal", "reptile", "fish", "none of the above"],
    answer: "mammal",
  },
  {
    title: "A blue whale is a?",
    choices: ["carnivore", "herbivore", "fish", "none of the above"],
    answer: "carnivore",
  },
  {
    title: "A blue whale is a?",
  ...
  {
    title: "The innermost layer of the earth is called?",
    choices: ["core", "crust", "mantle", "ozone"],
    answer: "core",
  },
  {
    title: "The outermost layer of the earth is called?",
    choices: ["core", "crust", "mantle", "ozone"],
    answer: "crust",
  },
  {
    title: "Which scientist proposed the three laws of motion?",
    choices: [
      "Isaac Newton",
      "thomas edison",
      "nikola tesla",
  ...
  {
    title: "Which scientist proposed the theory of evolution?",
    choices: [
      "Isaac Newton",
      "thomas edison",
      "nikola tesla",
  ...
  {
    title: "The layer of Gas which surrounds the Earth is called the:",
    choices: ["atmosphere", "lithosphere", "ionosphere", "ozone layer"],
    answer: "atmosphere",
  },
  {
    title:
      "Which of these famous scientists won a Nobel price in both Chemistry and Physics?",
    choices: [
      "albert einstein",
      "charles darwin",
      "Louis Pasteur",
  ...
  {
    title: "The scientist who created the periodic table is?",
    choices: [
      "Dmitri Mendeleev",
      "Michael Faraday",
      "Albert Einstein",
  ...
  {
    title: "Lightening is?",
    choices: ["electricity", "laser", "super heated liquid", "gamma ray"],
    answer: "electricity",
  },
  {
  ...
  },
  {
    ...
    choices: ["Vatican City", "Mauritius", "Monaco", "Liechtenstein"],
    answer: "Vatican City",
  },
  {
    title: "The smallest country in Africa is?",
    choices: [
      "Seychelles",
      "Vatican City",
  ...
  {
    title: "Your hair and your nails are made from the same material called?",
